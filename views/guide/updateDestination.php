...
<body>
    <div class="container">
        ...
        <form action="updateDestination.php?id=<?php echo $destination_id; ?>" method="POST" enctype="multipart/form-data">
            ...
            <input type="text" id="name" class="form-control" name="name" value="<?php echo htmlspecialchars($destination['name']); ?>" required>
        </div>
        <div class="form-group">
            <label for="description">Description:</label>
            <textarea id="description" class="form-control" name="description" required><?php echo htmlspecialchars($destination['description']); ?></textarea>
        </div>
        <div class="form-group">
            <label for="location">Location:</label>
            <input type="text" id="location" class="form-control" name="location" value="<?php echo htmlspecialchars($destination['location']); ?>" required>
        </div>

        <div class="form-group">
            <label for="image">Image:</label>
            <input type="text" id="image" class="form-control" name="image" value="<?php echo htmlspecialchars($destination['image_url']); ?>" required>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" id="best_time" class="form-control" name="best_time" value="<?php echo htmlspecialchars($destination['best_season']); ?>" required>
        </div>
    
        <div class="form-group">
            <label for="accessibility">Accessibility:</label>
            <select id="accessibility" class="form-control" name="accessibility" required>
